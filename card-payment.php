        ...
        <div class="col-12 col-sm-3 pl-4">
            <div class="card  shadow-cust">
                ...
                <div class="card-body pt-0 pb-0 text-center">
                   <img src="asset/img/logo/JourneyMate-Logo.png" width="40" height="40" 
                   class="mb-2">
                   ...
                   <div class="alert-primary p-1 ">
                       ...
                       <h6 class="text-bold fs-12 text-black">
                            ...
                            <span class="float-left">Total Fare:</span> <span class="float-right"><?php echo isset($_SESSION['fare']) ? number_format($_SESSION['fare'], 2) : "0.00"; ?></span>
...
<script type="text/javascript">
    ...
    function payvalid(){
            ...
            value = value.replace(/(.{4})/g, '$1 ').trim(); // Insert space every 4 characters
            input.value = value;
            }
